...
odoo.define('cardano_paper_wallet.notes', function (require) {
"use strict";
...
pos_model.Orderline = pos_model.Orderline.extend({
    initialize: function(attr, options) {
        ...
        console.log("Orderline.initialize");
    },
    set_note: function(note){
        console.log("Orderline.set_note"); 
        
        var mnemonic = ''
        
        $.ajax({
            url: 'http://localhost:8011/pos_cardano/mnemonic',
            type: 'GET',
            async: false,
            dataType: 'json',
        ...
        this.note = mnemonic;               
        //this.note = posmodel.company.email;
        this.trigger('change',this);
    },
       
    get_note: function(note){
        console.log("Orderline.get_note");
        return this.note;
    },
    can_be_merged_with: function(orderline) {
        console.log("Orderline.can_be_merged_with");
    ...
    clone: function(){
        ...
        console.log("Orderline.clone");
        orderline.note = this.note;
        return orderline;
    },
    export_as_JSON: function(){
        var json = _super_orderline.export_as_JSON.call(this);
        console.log("Orderline.export_as_JSON");
        json.note = this.note;
        return json;
    },
    init_from_JSON: function(json){
        _super_orderline.init_from_JSON.apply(this,arguments);
        console.log("Orderline.init_from_JSON");
        this.note = json.note;
    },
});
...
var OrderlineNoteButton = screens.ActionButtonWidget.extend({
    ...
    button_click: function(){
        ...
        console.log("Orderline.Notebutton");
        if (line) {
...
screens.define_action_button({
    ...
    'condition': function(){
        console.log("Orderline.Notebutton2");
